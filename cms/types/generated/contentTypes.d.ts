...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    blogCategories: Schema.Attribute.Relation<
      ...
      'api::blog-category.blog-category'
    >;
    blogTags: Schema.Attribute.Relation<'manyToMany', 'api::blog-tag.blog-tag'>;
...
export interface ApiProductCategoryProductCategory
  ...
  info: {
    description: 'Product categories (e.g. Tile Adhesives, Grouts)';
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    areasOfApplication: Schema.Attribute.Blocks;
    brochure: Schema.Attribute.Media<'files'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    faqs: Schema.Attribute.Component<'product.faq', true>;
    features: Schema.Attribute.Component<'product.feature', true>;
    highlight: Schema.Attribute.Component<'product.highlight', false>;
    howToUse: Schema.Attribute.Component<'product.how-to-use-step', true>;
